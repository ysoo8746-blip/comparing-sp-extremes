...
If raw data access is required, ERA5  and CPC-CONUS data are publicly available from the Copernicus Climate Data Store.
...
All function files are sourced within the main scripts in the `Functions/` directory.
